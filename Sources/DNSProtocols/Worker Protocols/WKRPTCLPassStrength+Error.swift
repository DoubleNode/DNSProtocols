//
//  WKRPTCLPassStrength+Error.swift
...
public extension DNSError {
    typealias PassStrength = WKRPTCLPassStrengthError
}
public enum WKRPTCLPassStrengthError: DNSError {
    // Common Errors
    ...
    public var errorString: String {
        ...
        case .notFound(let field, let value, _):
            return String(format: NSLocalizedString("WKRPWDSTR-Not Found%@%@%@", comment: ""),
                          "\(field)", "\(value)",
        ...
        case .invalidParameters(let parameters, _):
            ...
            return String(format: NSLocalizedString("WKRPWDSTR-Invalid Parameters%@%@", comment: ""),
                          "\(parametersString)",
                          " (\(Self.domain):\(Self.Code.invalidParameters.rawValue))")
        case .lowerError(let error, _):
            return String(format: NSLocalizedString("WKRPWDSTR-Lower Error%@%@", comment: ""),
