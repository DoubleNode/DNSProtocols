//
//  WKRPTCLPermissions+Error.swift
...
public enum WKRPTCLPermissionsError: DNSError {
    ...
    public var errorString: String {
        ...
        case .notFound(let field, let value, _):
            return String(format: NSLocalizedString("WKRPERMISSIONS-Not Found(%@=\"%@\")%@", comment: ""),
                          "\(field)", "\(value)",
        ...
        case .invalidParameters(let parameters, _):
            ...
            return String(format: NSLocalizedString("WKRPERMISSIONS-Invalid Parameters(%@)%@", comment: ""),
                          "\(parametersString)",
                          " (\(Self.domain):\(Self.Code.invalidParameters.rawValue))")
        case .lowerError(let error, _):
            return String(format: NSLocalizedString("WKRPERMISSIONS-Lower Error%@%@", comment: ""),
