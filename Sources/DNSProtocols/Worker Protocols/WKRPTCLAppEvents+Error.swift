...
public enum WKRPTCLAppEventsError: DNSError {
    ...
    public var errorString: String {
        ...
        case .notFound(let field, let value, _):
            return String(format: NSLocalizedString("WKRAPPEVENTS-Not Found(%@=\"%@\")%@", comment: ""),
                          "\(field)", "\(value)",
        ...
        case .invalidParameters(let parameters, _):
            ...
            return String(format: NSLocalizedString("WKRAPPEVENTS-Invalid Parameters(%@)%@", comment: ""),
                          "\(parametersString)",
                          " (\(Self.domain):\(Self.Code.invalidParameters.rawValue))")
        case .lowerError(let error, _):
            return String(format: NSLocalizedString("WKRAPPEVENTS-Lower Error%@%@", comment: ""),
