...
public enum WKRPTCLActivitiesError: DNSError {
    ...
    public var errorString: String {
        ...
        case .notFound(let field, let value, _):
            return String(format: NSLocalizedString("WKRACTIVITIES-Not Found(%@=\"%@\")%@", comment: ""),
                          "\(field)", "\(value)",
        ...
        case .invalidParameters(let parameters, _):
            ...
            return String(format: NSLocalizedString("WKRACTIVITIES-Invalid Parameters(%@)%@", comment: ""),
                          "\(parametersString)",
